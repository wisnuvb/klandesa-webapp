      ...
      <div className="relative bg-gradient-to-br from-[#0d9488] via-[#0f766e] to-[#0d9488] px-8 pt-32 pb-20 md:px-12 md:pt-40 md:pb-24 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-8">
            Buka lowongan sebagai partner: bantu desa kenal Klandesa, dan dapatkan bagi hasil
            yang jelas setiap kesepakatan selesai.
          </p>
          <a
            href="#daftar-mitra"
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-12 md:py-16 max-w-7xl mx-auto -mt-12 relative z-10">
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {benefits.map((item) => (
            ...
            >
              <div className="inline-flex p-4 rounded-xl bg-gradient-to-br from-[#0d9488] to-[#0f766e] mb-4">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 md:p-10 border border-gray-200 mb-16">
          ...
          <div className="max-w-xl mx-auto">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="partner-region" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#0d9488] to-[#0f766e] text-white py-3.5 rounded-xl font-medium hover:shadow-lg transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    "Mengirim…"
                  ) : (
